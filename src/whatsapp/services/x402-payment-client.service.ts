...
export class X402PaymentClientService {
  ...
  async initiatePayment(params: {
    ...
    try {
      ...
      // Si llegamos aquí con 200, es settlement directo (raro sin X-PAYMENT)
      return {
        ok: true,
  ...
  async verifyFiatPayment(params: {
    ...
    try {
      ...
      // 402 = verificación fallida, devolver opciones actualizadas
   ...
   * El QR ya viene en formato base64 listo para usar.
   */
  decodeQrBase64(base64QrSimple: string): string {
    // El QR ya está en base64, solo lo retornamos
